...
export default function WhatsAppButton({ phone, message }: WhatsAppButtonProps) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center justify-end">
      {/* Tooltip */}
      <span
        className={`mr-3 whitespace-nowrap rounded-lg border border-white/10 bg-neutral-900 px-3 py-1.5 text-sm font-medium text-white shadow-xl backdrop-blur-sm transition-all duration-300 ${
